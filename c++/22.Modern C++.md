...
### 22.5.5 Parallel accumulate algorithm implementation with async task
...
### 22.5.7 Communication between threads : `std::promises`



### 22.5.8 Retrieving exception using `std::futures`



### 22.5.9 std::shared_futures
