#include<iostream>
#include<vector>
//#include"minimum_length_subarray.h"
#include"Mystring.h"
...
//int main() {
//	vector<int> test_array_for_minimum_length_subarray{2, 3, 1, 2, 4, 3};
//	int target_for_minimum_length_subarray{ 7 };
//
//	Solution temp;
//	cout << temp.minSubArrayLen(target_for_minimum_length_subarray, test_array_for_minimum_length_subarray);
//
//}
